...
impl Scalar for u8 {
    ...
    const SCALAR_MAX: Self = u8::MAX;
    const SCALAR_MIN: Self = u8::MIN;
    ...
    fn requantize<T: Scalar>(self, rounding: Rounding) -> T {
        ...
        // Same result for all rounding modes in this case.
    ...
    fn u8_check() {
        ...
        for i in 0..=255u8 {
            ...
            for r in Rounding::iter_all() {
                ...
                let v0 = u16::from_norm(norm, r);
                let v1: u16 = i.requantize(r);
                assert_eq!(v0, uint16[i as usize]);
                assert_eq!(v1, uint16[i as usize]);
